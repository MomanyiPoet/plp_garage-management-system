            ...
            <div class="container">
                <div class="cwp4-two row">
                    <div class="cwp4-image col-xl-6">
                        <img src="assets/images/garage1.jpg" alt="product" class="img-responsive about-me">
                    </div>
                    <div class="cwp4-text col-xl-6 ">
                        <div class="posivtion-grid">
                            <h3 class="">Garage and success starts here</h3>
                            <div class="hair-two-colums">
                                <div class="hair-left">
                                    <h5>
                                        Bodywork and Paint</h5>
                                </div>
                                <div class="hair-left">
                                    <h5>Air Conditioning and Heating</h5>
        ...
        <div class="jst-two-col">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 ">
                        <img src="assets/images/about-us.png" alt="product" class="img-responsive about-me">
                    </div>
